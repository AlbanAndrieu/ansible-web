# Ansible managed: /workspace/users/albandri10/env/ansible/roles/web/templates/Dockerfile.j2 modified on 2014-11-06 00:54:50 by albandri on albandri-laptop-misys.misys.global.ad
#FROM        debian:jessie
